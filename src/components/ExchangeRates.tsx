...
export const ExchangeRates: React.FC = () => {
  ...
  return (
    <div className="space-y-4 pb-24">
      ...
      >
        <div>
          <h2 className="text-2xl font-bold text-light-text dark:text-dark-text font-editorial">Exchange Rates</h2>
          <p className="text-light-text-secondary dark:text-dark-text-secondary text-sm">Real-time rates</p>
        </div>
        <motion.button
          whileTap={{ scale: 0.95 }}
        ...
        >
          <RefreshCw className="w-4 h-4 text-light-text dark:text-dark-text" />
        </motion.button>
      </motion.div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {exchangeRates.map((rate, index) => (
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-light-surface/50 dark:bg-dark-surface/50 backdrop-blur-sm border border-light-border dark:border-dark-border rounded-xl p-4 hover:border-lime-accent/30 transition-all hover:shadow-glow duration-300"
          >
            {/* Pair Header */}
            <div className="flex items-center justify-between mb-3">
              <div>
                <h3 className="text-lg font-bold text-light-text dark:text-dark-text font-editorial">{rate.pair}</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-baseline space-x-2">
                <motion.span
                  ...
                  className="text-2xl font-bold text-lime-accent font-editorial"
                >
                  {rate.rate.toFixed(4)}
                </motion.span>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-light-surface/80 to-light-glass dark:from-dark-surface/80 dark:to-dark-glass border border-light-border dark:border-dark-border rounded-2xl p-4 shadow-glass transition-colors duration-300"
      >
        <h3 className="text-lg font-bold text-light-text dark:text-dark-text font-editorial mb-4">Quick Exchange</h3>
